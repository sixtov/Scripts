...
/**
Message ID: VICON_POSITION_ESTIMATE(104)
--------------------------------------
--------------------------------------
*/
public class VICON_POSITION_ESTIMATE_class //implements Loggable
{
	public static final int msgID = 104;
	...
	public VICON_POSITION_ESTIMATE_class()
	{
		rcvPacket = new packet(msgID);
		sndPacket = new packet(msgID);
	}

	public VICON_POSITION_ESTIMATE_class(VICON_POSITION_ESTIMATE_class o)
	{
		usec = o.usec;
		x = o.x;
		y = o.y;
	...
	public String getLogHeader()
	{
		String param = (
				  "  time"
 				+ ", VICON_POSITION_ESTIMATE_usec"
 				+ ", VICON_POSITION_ESTIMATE_x"
 				+ ", VICON_POSITION_ESTIMATE_y"
 				+ ", VICON_POSITION_ESTIMATE_z"
 				+ ", VICON_POSITION_ESTIMATE_roll"
 				+ ", VICON_POSITION_ESTIMATE_pitch"
 				+ ", VICON_POSITION_ESTIMATE_yaw"
				);
		return param;
	}
