...
public class SCALED_IMU2_class //implements Loggable
{
	...
	public SCALED_IMU2_class()
	{
		rcvPacket = new packet(msgID);
		sndPacket = new packet(msgID);
	}

	public SCALED_IMU2_class(SCALED_IMU2_class o)
	{
