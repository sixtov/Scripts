...
public class HIL_STATE_QUATERNION_class //implements Loggable
{
	...
	public boolean parse(byte[] b, boolean valid)
	{
		...
		if (pstatus)
		{
			...
			// int[] mavLen = {8, 4, 4, 4, 4, 4, 4, 4, 2, 2, 2, 2, 2, 2, 2, 2};
			// int[] javLen = {8, 16, 4, 4, 4, 4, 4, 4, 2, 2, 2, 4, 4, 2, 2, 2};

			time_usec			= rcvPacket.getLong();
			rcvPacket.getByte(attitude_quaternion, 0, 16);
						...
						)
	{
		...
		sndPacket.putByte(v_attitude_quaternion,0,16);	// Add "attitude_quaternion" parameter
