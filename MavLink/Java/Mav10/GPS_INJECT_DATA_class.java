...
public class GPS_INJECT_DATA_class //implements Loggable
{
	...
	public short[]	 data = new short[220];				// raw data (110 is enough for 12 satellites of RTCMv2)
...
//	ERROR	Parsing 'data' array of 'short' from 'uint8_t[110]'
		}
		return(pstatus);
	}
...
//	ERROR	Encoding 'data' array of 'short' from 'uint8_t[110]'
	// Add "data" parameter
