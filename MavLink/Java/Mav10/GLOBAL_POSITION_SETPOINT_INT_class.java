...
/**
Message ID: GLOBAL_POSITION_SETPOINT_INT(52)
--------------------------------------
%%~ Transmit the current local setpoint of the controller to other MAVs (collision avoidance) 
%%~ and to the GCS.
--------------------------------------
*/
public class GLOBAL_POSITION_SETPOINT_INT_class //implements Loggable
{
	...
	public GLOBAL_POSITION_SETPOINT_INT_class()
	{
		rcvPacket = new packet(msgID);
		sndPacket = new packet(msgID);
	}

	public GLOBAL_POSITION_SETPOINT_INT_class(GLOBAL_POSITION_SETPOINT_INT_class o)
	{
	...
	public String getLogHeader()
	{
		String param = (
				  "  time"
 				+ ", GLOBAL_POSITION_SETPOINT_INT_coordinate_frame"
 				+ ", GLOBAL_POSITION_SETPOINT_INT_latitude"
 				+ ", GLOBAL_POSITION_SETPOINT_INT_longitude"
 				+ ", GLOBAL_POSITION_SETPOINT_INT_altitude"
 				+ ", GLOBAL_POSITION_SETPOINT_INT_yaw"
				);
		return param;
	}
