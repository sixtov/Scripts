...
public class FILE_TRANSFER_PROTOCOL_class //implements Loggable
{
	...
	public short[]	 payload = new short[502];				// Variable length payload. The length is defined by the remaining message length when subtracting the header and other fields.  The entire content of this block is opaque unless you understand any the encoding message_type.  The particular encoding used can be extension specific and might not always be documented as part of the mavlink specification.
...
//	ERROR	Parsing 'payload' array of 'short' from 'uint8_t[251]'
		}
		return(pstatus);
	}
...
//	ERROR	Encoding 'payload' array of 'short' from 'uint8_t[251]'
