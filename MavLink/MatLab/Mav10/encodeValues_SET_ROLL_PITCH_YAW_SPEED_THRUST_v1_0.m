...
function p = encodeValues_SET_ROLL_PITCH_YAW_SPEED_THRUST_v1_0(target_system,target_component,roll_speed,pitch_speed,yaw_speed,thrust)
	...
	p = encode_SET_ROLL_PITCH_YAW_SPEED_THRUST_v1_0(S);
return
