...
function p = encodeValues_MISSION_ITEM_INT_v1_0(target_system,target_component,seq,frame,command,current,autocontinue,param1,param2,param3,param4,x,y,z)
	...
	S.seq = typecast(uint16(seq),'uint16');		% Waypoint ID (sequence number). Starts at zero. Increases monotonically for each waypoint, no gaps in the sequence (0,1,2,3,4).
	...
	S.y = typecast(int32(y),'int32');		% PARAM6 / y position: local: x position in meters * 1e4, global: longitude in degrees *10^7
