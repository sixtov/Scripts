...
function p = encodeValues_DIGICAM_CONTROL_v1_0(target_system,target_component,session,zoom_pos,zoom_step,focus_lock,shot,command_id,extra_param,extra_value)
	...
	p = encode_DIGICAM_CONTROL_v1_0(S);
return
