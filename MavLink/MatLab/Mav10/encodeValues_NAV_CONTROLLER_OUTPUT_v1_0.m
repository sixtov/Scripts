...
function p = encodeValues_NAV_CONTROLLER_OUTPUT_v1_0(nav_roll,nav_pitch,nav_bearing,target_bearing,wp_dist,alt_error,aspd_error,xtrack_error,nav_wptrad)
	...
	S.nav_wptrad = typecast(single(nav_wptrad),'single');		% Navigation waypoint radius in meters
