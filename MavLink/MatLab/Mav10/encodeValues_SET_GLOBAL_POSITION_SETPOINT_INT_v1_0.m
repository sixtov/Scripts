...
function p = encodeValues_SET_GLOBAL_POSITION_SETPOINT_INT_v1_0(coordinate_frame,latitude,longitude,altitude,yaw)
	...
	p = encode_SET_GLOBAL_POSITION_SETPOINT_INT_v1_0(S);
return
