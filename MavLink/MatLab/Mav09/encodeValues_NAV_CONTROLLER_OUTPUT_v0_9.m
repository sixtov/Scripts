...
function p = encodeValues_NAV_CONTROLLER_OUTPUT_v0_9(nav_roll,nav_pitch,nav_bearing,target_bearing,wp_dist,alt_error,aspd_error,xtrack_error)
	...
	S.target_bearing = typecast(int16(target_bearing),'int16');		% Bearing to current waypoint/target in degrees
	S.wp_dist = typecast(uint16(wp_dist),'uint16');		% Distance to active waypoint in meters
