	...
	)
{
	...
	memcpy(_MAV_PAYLOAD(msg), buf, MAVLINK_MSG_ID_GPS_SET_GLOBAL_ORIGIN_LEN);
#else
	...
	memcpy(_MAV_PAYLOAD(msg), &packet, MAVLINK_MSG_ID_GPS_SET_GLOBAL_ORIGIN_LEN);
#endif
...
static inline uint16_t mavlink_msg_gps_set_global_origin_encode(
	...
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_gps_set_global_origin_t* gps_set_global_origin
	)
{
	return mavlink_msg_gps_set_global_origin_pack(
	 system_id
	,component_id
	,msg
	,gps_set_global_origin->target_system
	,gps_set_global_origin->target_component
	,gps_set_global_origin->latitude
	,gps_set_global_origin->longitude
	,gps_set_global_origin->altitude
	);
}
...
static inline void mavlink_msg_wID_gps_set_global_origin_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_SET_GLOBAL_ORIGIN, buf, MAVLINK_MSG_ID_GPS_SET_GLOBAL_ORIGIN_LEN);
#else
	mavlink_gps_set_global_origin_t packet;
	packet.target_system = target_system;
	packet.target_component = target_component;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_SET_GLOBAL_ORIGIN, (const char*)&packet, MAVLINK_MSG_ID_GPS_SET_GLOBAL_ORIGIN_LEN);
#endif
}
