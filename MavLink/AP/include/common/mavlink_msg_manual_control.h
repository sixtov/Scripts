	...
	)
{
	...
	memcpy(_MAV_PAYLOAD(msg), &packet, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN);
#endif
	...
	)
{
	...
	,manual_control->yaw
	,manual_control->thrust
	,manual_control->roll_manual
	,manual_control->pitch_manual
	,manual_control->yaw_manual
	,manual_control->thrust_manual
	);
}
