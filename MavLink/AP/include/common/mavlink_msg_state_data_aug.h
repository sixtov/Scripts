...
{ \
  ...
  5, \
  { \
    { "usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_state_data_aug_t, usec) }, \
    { "num", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_state_data_aug_t, num) }, \
    { "atloiter", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_state_data_aug_t, atloiter) }, \
    { "mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 10, offsetof(mavlink_state_data_aug_t, mode) }, \
    { "RC_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 11, offsetof(mavlink_state_data_aug_t, RC_state) }, \
  } \
}
	...
	)
{
	...
	_mav_put_uint8_t(buf, 11, RC_state);
