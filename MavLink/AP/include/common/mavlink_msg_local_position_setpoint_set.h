	...
	)
{
	...
	memcpy(_MAV_PAYLOAD(msg), buf, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN);
#else
	...
	memcpy(_MAV_PAYLOAD(msg), &packet, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN);
#endif
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_local_position_setpoint_set_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_local_position_setpoint_set_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_local_position_setpoint_set_t* local_position_setpoint_set
	)
{
	return mavlink_msg_local_position_setpoint_set_pack(
	 system_id
	,component_id
	,msg
	,local_position_setpoint_set->target_system
	,local_position_setpoint_set->target_component
	,local_position_setpoint_set->x
	,local_position_setpoint_set->y
	,local_position_setpoint_set->z
	,local_position_setpoint_set->yaw
	);
}
...
static inline void mavlink_msg_wID_local_position_setpoint_set_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET, buf, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN);
#else
	mavlink_local_position_setpoint_set_t packet;
	packet.target_system = target_system;
	packet.target_component = target_component;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET, (const char*)&packet, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN);
#endif
}
