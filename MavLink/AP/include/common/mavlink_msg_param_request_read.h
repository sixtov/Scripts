...
{ \
  ...
  4, \
  { \
    { "param_id", NULL, MAVLINK_TYPE_UINT8_T, 15, 0, offsetof(mavlink_param_request_read_t, param_id) }, \
    { "param_index", NULL, MAVLINK_TYPE_INT16_T, 0, 15, offsetof(mavlink_param_request_read_t, param_index) }, \
    { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 17, offsetof(mavlink_param_request_read_t, target_system) }, \
    { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 18, offsetof(mavlink_param_request_read_t, target_component) }, \
  } \
}
	...
	)
{
	...
	_mav_put_int16_t(buf, 15, param_index);
	_mav_put_uint8_t_array(buf, 17, target_system, 0);
	_mav_put_uint8_t(buf, 18, target_component);

	memcpy(_MAV_PAYLOAD(msg), buf, MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN);
#else
	...
	memcpy(_MAV_PAYLOAD(msg), &packet, MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN);
#endif
 ...
 */
static inline uint8_t mavlink_msg_param_request_read_get_param_id(const mavlink_message_t* msg, uint8_t* param_id)
{
