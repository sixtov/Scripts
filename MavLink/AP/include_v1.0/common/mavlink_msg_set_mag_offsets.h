...
#define MAVLINK_MSG_ID_SET_MAG_OFFSETS_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_set_mag_offsets_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_set_mag_offsets_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_set_mag_offsets_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	...
	)
{
	...
	,component_id
	,msg
	,set_mag_offsets->target_system
	,set_mag_offsets->target_component
	,set_mag_offsets->mag_ofs_x
	,set_mag_offsets->mag_ofs_y
	,set_mag_offsets->mag_ofs_z
	);
}
 ...
 * @param set_mag_offsets C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_mag_offsets_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_set_mag_offsets_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_set_mag_offsets_send(
...
static inline void mavlink_msg_wID_set_mag_offsets_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_MAG_OFFSETS, buf, MAVLINK_MSG_ID_SET_MAG_OFFSETS_LEN, MAVLINK_MSG_ID_SET_MAG_OFFSETS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_MAG_OFFSETS, buf, MAVLINK_MSG_ID_SET_MAG_OFFSETS_LEN);
#endif
#else
	mavlink_set_mag_offsets_t packet;
	packet.target_system = target_system;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_MAG_OFFSETS, (const char*)&packet, MAVLINK_MSG_ID_SET_MAG_OFFSETS_LEN, MAVLINK_MSG_ID_SET_MAG_OFFSETS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_MAG_OFFSETS, (const char*)&packet, MAVLINK_MSG_ID_SET_MAG_OFFSETS_LEN);
#endif
#endif
}
