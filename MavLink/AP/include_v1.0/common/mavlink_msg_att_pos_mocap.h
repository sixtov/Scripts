...
#define MAVLINK_MSG_ID_ATT_POS_MOCAP_CRC 0
#define MAVLINK_MSG_ID_138_CRC 0
...
{ \
  ...
  { \
    ...
    { "x", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_att_pos_mocap_t, x) }, \
    { "y", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_att_pos_mocap_t, y) }, \
    { "z", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_att_pos_mocap_t, z) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_att_pos_mocap_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_att_pos_mocap_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
/**
 * @brief Encode a att_pos_mocap struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_att_pos_mocap_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_att_pos_mocap_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_att_pos_mocap_send(
...
static inline void mavlink_msg_wID_att_pos_mocap_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t time_usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ATT_POS_MOCAP, buf, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN, MAVLINK_MSG_ID_ATT_POS_MOCAP_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ATT_POS_MOCAP, buf, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN);
#endif
#else
	mavlink_att_pos_mocap_t packet;
	packet.time_usec = time_usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ATT_POS_MOCAP, (const char*)&packet, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN, MAVLINK_MSG_ID_ATT_POS_MOCAP_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ATT_POS_MOCAP, (const char*)&packet, MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN);
#endif
#endif
}
 ...
 */
static inline float mavlink_msg_att_pos_mocap_get_q(const mavlink_message_t* msg, float* q)
{
