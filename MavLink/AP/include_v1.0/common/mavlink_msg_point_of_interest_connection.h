...
#define MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_CRC 0
#define MAVLINK_MSG_ID_192_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_point_of_interest_connection_pack(
	 uint8_t system_id
...
{
	return mavlink_msg_point_of_interest_connection_pack(
	 system_id
	,component_id
	,msg
	,point_of_interest_connection->type
	,point_of_interest_connection->color
	,point_of_interest_connection->coordinate_system
	,point_of_interest_connection->timeout
	,point_of_interest_connection->xp1
	,point_of_interest_connection->yp1
	,point_of_interest_connection->zp1
	,point_of_interest_connection->xp2
	,point_of_interest_connection->yp2
	,point_of_interest_connection->zp2
	,point_of_interest_connection->name
	);
}
 ...
 * @param point_of_interest_connection C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_point_of_interest_connection_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_point_of_interest_connection_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_point_of_interest_connection_send(
...
static inline void mavlink_msg_wID_point_of_interest_connection_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t type
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION, buf, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION, buf, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN);
#endif
#else
	mavlink_point_of_interest_connection_t packet;
	packet.type = type;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION, (const char*)&packet, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION, (const char*)&packet, MAVLINK_MSG_ID_POINT_OF_INTEREST_CONNECTION_LEN);
#endif
#endif
}
 ...
 */
static inline char mavlink_msg_point_of_interest_connection_get_name(const mavlink_message_t* msg, char* name)
{
