...
#define MAVLINK_MSG_ID_POWER_STATUS_CRC 0
#define MAVLINK_MSG_ID_125_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_power_status_pack(
	 uint8_t system_id
...
/**
 * @brief Encode a power_status struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_power_status_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param power_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_power_status_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_power_status_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_power_status_send(
...
static inline void mavlink_msg_wID_power_status_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint16_t Vcc
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POWER_STATUS, buf, MAVLINK_MSG_ID_POWER_STATUS_LEN, MAVLINK_MSG_ID_POWER_STATUS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POWER_STATUS, buf, MAVLINK_MSG_ID_POWER_STATUS_LEN);
#endif
#else
	mavlink_power_status_t packet;
	packet.Vcc = Vcc;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POWER_STATUS, (const char*)&packet, MAVLINK_MSG_ID_POWER_STATUS_LEN, MAVLINK_MSG_ID_POWER_STATUS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POWER_STATUS, (const char*)&packet, MAVLINK_MSG_ID_POWER_STATUS_LEN);
#endif
#endif
}
