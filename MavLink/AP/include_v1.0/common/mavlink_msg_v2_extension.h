...
#define MAVLINK_MSG_ID_V2_EXTENSION_CRC 0
#define MAVLINK_MSG_ID_248_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_v2_extension_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_v2_extension_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
/**
 * @brief Encode a v2_extension struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_v2_extension_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	...
	)
{
	...
	,component_id
	,msg
	,v2_extension->target_network
	,v2_extension->target_system
	,v2_extension->target_component
	,v2_extension->message_type
	,v2_extension->payload
	);
}
 ...
 * @param v2_extension C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_v2_extension_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_v2_extension_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_v2_extension_send(
...
static inline void mavlink_msg_wID_v2_extension_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_network
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_V2_EXTENSION, buf, MAVLINK_MSG_ID_V2_EXTENSION_LEN, MAVLINK_MSG_ID_V2_EXTENSION_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_V2_EXTENSION, buf, MAVLINK_MSG_ID_V2_EXTENSION_LEN);
#endif
#else
	mavlink_v2_extension_t packet;
	packet.target_network = target_network;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_V2_EXTENSION, (const char*)&packet, MAVLINK_MSG_ID_V2_EXTENSION_LEN, MAVLINK_MSG_ID_V2_EXTENSION_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_V2_EXTENSION, (const char*)&packet, MAVLINK_MSG_ID_V2_EXTENSION_LEN);
#endif
#endif
}
 ...
 */
static inline uint8_t mavlink_msg_v2_extension_get_payload(const mavlink_message_t* msg, uint8_t* payload)
{
