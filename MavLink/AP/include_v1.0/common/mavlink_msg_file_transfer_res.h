...
#define MAVLINK_MSG_ID_FILE_TRANSFER_RES_CRC 0
#define MAVLINK_MSG_ID_112_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_file_transfer_res_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_file_transfer_res_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_file_transfer_res_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_file_transfer_res_t* file_transfer_res
	)
{
	return mavlink_msg_file_transfer_res_pack(
	 system_id
	,component_id
	,msg
	,file_transfer_res->transfer_uid
	,file_transfer_res->result
	);
}
 ...
 * @param file_transfer_res C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_file_transfer_res_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_file_transfer_res_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_file_transfer_res_send(
...
static inline void mavlink_msg_wID_file_transfer_res_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t transfer_uid
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_FILE_TRANSFER_RES, buf, MAVLINK_MSG_ID_FILE_TRANSFER_RES_LEN, MAVLINK_MSG_ID_FILE_TRANSFER_RES_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_FILE_TRANSFER_RES, buf, MAVLINK_MSG_ID_FILE_TRANSFER_RES_LEN);
#endif
#else
	mavlink_file_transfer_res_t packet;
	packet.transfer_uid = transfer_uid;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_FILE_TRANSFER_RES, (const char*)&packet, MAVLINK_MSG_ID_FILE_TRANSFER_RES_LEN, MAVLINK_MSG_ID_FILE_TRANSFER_RES_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_FILE_TRANSFER_RES, (const char*)&packet, MAVLINK_MSG_ID_FILE_TRANSFER_RES_LEN);
#endif
#endif
}
