...
#define MAVLINK_MSG_ID_MANUAL_CONTROL_CRC 0
#define MAVLINK_MSG_ID_69_CRC 0
...
{ \
  ...
  { \
    ...
    { "x", NULL, MAVLINK_TYPE_INT16_T, 0, 1, offsetof(mavlink_manual_control_t, x) }, \
    { "y", NULL, MAVLINK_TYPE_INT16_T, 0, 3, offsetof(mavlink_manual_control_t, y) }, \
    { "z", NULL, MAVLINK_TYPE_INT16_T, 0, 5, offsetof(mavlink_manual_control_t, z) }, \
    { "r", NULL, MAVLINK_TYPE_INT16_T, 0, 7, offsetof(mavlink_manual_control_t, r) }, \
    { "buttons", NULL, MAVLINK_TYPE_UINT16_T, 0, 9, offsetof(mavlink_manual_control_t, buttons) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_manual_control_pack(
	 uint8_t system_id
	...
	)
{
	...
	_mav_put_int16_t(buf, 1, x);
	_mav_put_int16_t(buf, 3, y);
	_mav_put_int16_t(buf, 5, z);
	_mav_put_int16_t(buf, 7, r);
	_mav_put_uint16_t(buf, 9, buttons);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_manual_control_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_manual_control_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
static inline void mavlink_msg_manual_control_send(
...
static inline void mavlink_msg_wID_manual_control_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MANUAL_CONTROL, buf, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN, MAVLINK_MSG_ID_MANUAL_CONTROL_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MANUAL_CONTROL, buf, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN);
#endif
#else
	mavlink_manual_control_t packet;
	packet.target = target;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MANUAL_CONTROL, (const char*)&packet, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN, MAVLINK_MSG_ID_MANUAL_CONTROL_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MANUAL_CONTROL, (const char*)&packet, MAVLINK_MSG_ID_MANUAL_CONTROL_LEN);
#endif
#endif
}
...
{
	return _MAV_RETURN_int16_t(msg,1);
}
