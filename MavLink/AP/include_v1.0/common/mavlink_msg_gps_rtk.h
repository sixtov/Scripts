...
#define MAVLINK_MSG_ID_GPS_RTK_CRC 0
#define MAVLINK_MSG_ID_127_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_gps_rtk_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_gps_rtk_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
/**
 * @brief Encode a gps_rtk struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_gps_rtk_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_gps_rtk_t* gps_rtk
	)
{
 ...
 * @param gps_rtk C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_gps_rtk_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_gps_rtk_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_wID_gps_rtk_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint32_t time_last_baseline_ms
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_RTK, buf, MAVLINK_MSG_ID_GPS_RTK_LEN, MAVLINK_MSG_ID_GPS_RTK_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_RTK, buf, MAVLINK_MSG_ID_GPS_RTK_LEN);
#endif
#else
	mavlink_gps_rtk_t packet;
	packet.time_last_baseline_ms = time_last_baseline_ms;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_RTK, (const char*)&packet, MAVLINK_MSG_ID_GPS_RTK_LEN, MAVLINK_MSG_ID_GPS_RTK_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_RTK, (const char*)&packet, MAVLINK_MSG_ID_GPS_RTK_LEN);
#endif
#endif
}
...
{
	return _MAV_RETURN_uint32_t(msg,7);
}
...
{
	return _MAV_RETURN_int32_t(msg,23);
}
