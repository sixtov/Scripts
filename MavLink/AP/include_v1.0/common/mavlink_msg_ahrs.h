...
#define MAVLINK_MSG_ID_AHRS_CRC 0
#define MAVLINK_MSG_ID_163_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_ahrs_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_ahrs_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_ahrs_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param ahrs C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_ahrs_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_ahrs_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_ahrs_send(
...
static inline void mavlink_msg_wID_ahrs_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,float omegaIx
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_AHRS, buf, MAVLINK_MSG_ID_AHRS_LEN, MAVLINK_MSG_ID_AHRS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_AHRS, buf, MAVLINK_MSG_ID_AHRS_LEN);
#endif
#else
	mavlink_ahrs_t packet;
	packet.omegaIx = omegaIx;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_AHRS, (const char*)&packet, MAVLINK_MSG_ID_AHRS_LEN, MAVLINK_MSG_ID_AHRS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_AHRS, (const char*)&packet, MAVLINK_MSG_ID_AHRS_LEN);
#endif
#endif
}
