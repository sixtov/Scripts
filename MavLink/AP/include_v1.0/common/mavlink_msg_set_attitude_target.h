...
#define MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_CRC 0
#define MAVLINK_MSG_ID_82_CRC 0
...
{ \
  ...
  { \
    ...
    { "body_roll_rate", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_set_attitude_target_t, body_roll_rate) }, \
    { "body_pitch_rate", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_set_attitude_target_t, body_pitch_rate) }, \
    { "body_yaw_rate", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_set_attitude_target_t, body_yaw_rate) }, \
    { "thrust", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_set_attitude_target_t, thrust) }, \
    { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_set_attitude_target_t, target_system) }, \
    { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 25, offsetof(mavlink_set_attitude_target_t, target_component) }, \
    { "type_mask", NULL, MAVLINK_TYPE_UINT8_T, 0, 26, offsetof(mavlink_set_attitude_target_t, type_mask) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_set_attitude_target_pack(
	 uint8_t system_id
	...
	)
{
	...
	mav_array_memcpy(packet.body_yaw_rate, body_yaw_rate, sizeof(float)*0);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_set_attitude_target_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
/**
 * @brief Encode a set_attitude_target struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_set_attitude_target_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param set_attitude_target C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_attitude_target_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_set_attitude_target_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_wID_set_attitude_target_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint32_t time_boot_ms
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET, buf, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET, buf, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN);
#endif
#else
	mavlink_set_attitude_target_t packet;
	packet.time_boot_ms = time_boot_ms;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET, (const char*)&packet, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET, (const char*)&packet, MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN);
#endif
#endif
}
 ...
 */
static inline float mavlink_msg_set_attitude_target_get_q(const mavlink_message_t* msg, float* q)
{
	return _MAV_RETURN_float_array(msg,q,4,7);
}
