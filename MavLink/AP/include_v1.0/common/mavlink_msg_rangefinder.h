...
#define MAVLINK_MSG_ID_RANGEFINDER_CRC 0
#define MAVLINK_MSG_ID_173_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_rangefinder_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_rangefinder_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_rangefinder_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_rangefinder_t* rangefinder
	)
{
 ...
 * @param rangefinder C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_rangefinder_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_rangefinder_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_rangefinder_send(
...
static inline void mavlink_msg_wID_rangefinder_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,float distance
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_RANGEFINDER, buf, MAVLINK_MSG_ID_RANGEFINDER_LEN, MAVLINK_MSG_ID_RANGEFINDER_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_RANGEFINDER, buf, MAVLINK_MSG_ID_RANGEFINDER_LEN);
#endif
#else
	mavlink_rangefinder_t packet;
	packet.distance = distance;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_RANGEFINDER, (const char*)&packet, MAVLINK_MSG_ID_RANGEFINDER_LEN, MAVLINK_MSG_ID_RANGEFINDER_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_RANGEFINDER, (const char*)&packet, MAVLINK_MSG_ID_RANGEFINDER_LEN);
#endif
#endif
}
