...
#define MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_CRC 0
#define MAVLINK_MSG_ID_180_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_watchdog_heartbeat_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_watchdog_heartbeat_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_watchdog_heartbeat_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_watchdog_heartbeat_t* watchdog_heartbeat
	)
{
	return mavlink_msg_watchdog_heartbeat_pack(
	 system_id
	,component_id
	,msg
	,watchdog_heartbeat->watchdog_id
	,watchdog_heartbeat->process_count
	);
}
 ...
 * @param watchdog_heartbeat C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_watchdog_heartbeat_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_watchdog_heartbeat_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_watchdog_heartbeat_send(
...
static inline void mavlink_msg_wID_watchdog_heartbeat_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint16_t watchdog_id
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT, buf, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT, buf, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN);
#endif
#else
	mavlink_watchdog_heartbeat_t packet;
	packet.watchdog_id = watchdog_id;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT, (const char*)&packet, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT, (const char*)&packet, MAVLINK_MSG_ID_WATCHDOG_HEARTBEAT_LEN);
#endif
#endif
}
