...
#define MAVLINK_MSG_ID_FENCE_POINT_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_fence_point_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_fence_point_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_fence_point_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_fence_point_pack(
	 system_id
	,component_id
	,msg
	,fence_point->target_system
	,fence_point->target_component
	,fence_point->idx
	,fence_point->count
	,fence_point->lat
	,fence_point->lng
 ...
 * @param fence_point C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_fence_point_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_fence_point_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_fence_point_send(
...
static inline void mavlink_msg_wID_fence_point_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_FENCE_POINT, buf, MAVLINK_MSG_ID_FENCE_POINT_LEN);
#endif
#else
	mavlink_fence_point_t packet;
	packet.target_system = target_system;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_FENCE_POINT, (const char*)&packet, MAVLINK_MSG_ID_FENCE_POINT_LEN, MAVLINK_MSG_ID_FENCE_POINT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_FENCE_POINT, (const char*)&packet, MAVLINK_MSG_ID_FENCE_POINT_LEN);
#endif
#endif
}
