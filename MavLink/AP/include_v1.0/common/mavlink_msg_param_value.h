...
{ 
  float param_value[0];  ///< Onboard parameter value
...
{ \
  ...
  { \
    ...
    { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_param_value_t, param_type) }, \
  } \
}
