...
#define MAVLINK_MSG_ID_MARKER_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_marker_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_marker_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_marker_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_marker_t* marker
	)
{
	return mavlink_msg_marker_pack(
	 system_id
	,component_id
	,msg
	,marker->id
 ...
 * @param marker C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_marker_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_marker_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_marker_send(
...
static inline void mavlink_msg_wID_marker_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint16_t id
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MARKER, buf, MAVLINK_MSG_ID_MARKER_LEN, MAVLINK_MSG_ID_MARKER_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MARKER, buf, MAVLINK_MSG_ID_MARKER_LEN);
#endif
#else
	mavlink_marker_t packet;
	packet.id = id;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MARKER, (const char*)&packet, MAVLINK_MSG_ID_MARKER_LEN, MAVLINK_MSG_ID_MARKER_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MARKER, (const char*)&packet, MAVLINK_MSG_ID_MARKER_LEN);
#endif
#endif
}
