...
#define MAVLINK_MSG_ID_DATA32_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_data32_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_data32_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_data32_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_data32_t* data32
	)
{
	return mavlink_msg_data32_pack(
	 system_id
	,component_id
	,msg
	,data32->type
...
{
	return mavlink_msg_data32_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_data32_send(
...
static inline void mavlink_msg_wID_data32_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t type
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_DATA32, buf, MAVLINK_MSG_ID_DATA32_LEN, MAVLINK_MSG_ID_DATA32_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_DATA32, buf, MAVLINK_MSG_ID_DATA32_LEN);
#endif
#else
	mavlink_data32_t packet;
	packet.type = type;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_DATA32, (const char*)&packet, MAVLINK_MSG_ID_DATA32_LEN, MAVLINK_MSG_ID_DATA32_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_DATA32, (const char*)&packet, MAVLINK_MSG_ID_DATA32_LEN);
#endif
#endif
}
 ...
 * @return raw data
 */
static inline uint8_t mavlink_msg_data32_get_data(const mavlink_message_t* msg, uint8_t* data)
{
