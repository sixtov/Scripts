...
#define MAVLINK_MSG_ID_DATA96_CRC 0
#define MAVLINK_MSG_ID_172_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_data96_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_data96_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_data96_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_data96_t* data96
	)
{
	return mavlink_msg_data96_pack(
	 system_id
	,component_id
	,msg
	,data96->type
 ...
 * @param data96 C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_data96_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
static inline void mavlink_msg_data96_send(
...
static inline void mavlink_msg_wID_data96_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t type
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_DATA96, buf, MAVLINK_MSG_ID_DATA96_LEN, MAVLINK_MSG_ID_DATA96_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_DATA96, buf, MAVLINK_MSG_ID_DATA96_LEN);
#endif
#else
	mavlink_data96_t packet;
	packet.type = type;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_DATA96, (const char*)&packet, MAVLINK_MSG_ID_DATA96_LEN, MAVLINK_MSG_ID_DATA96_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_DATA96, (const char*)&packet, MAVLINK_MSG_ID_DATA96_LEN);
#endif
#endif
}
 ...
 * @return raw data
 */
static inline uint8_t mavlink_msg_data96_get_data(const mavlink_message_t* msg, uint8_t* data)
{
