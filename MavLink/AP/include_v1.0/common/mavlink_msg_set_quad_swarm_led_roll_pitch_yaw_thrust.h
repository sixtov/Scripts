...
{ 
  int16_t roll;  ///< Desired roll angle in radians +-PI (+-INT16_MAX)
  int16_t pitch;  ///< Desired pitch angle in radians +-PI (+-INT16_MAX)
  ...
  uint8_t group[0];  ///< ID of the quadrotor group (0 - 255, up to 256 groups supported)
  uint8_t mode[0];  ///< ID of the flight mode (0 - 255, up to 256 modes supported)
...
#define MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_CRC 0
#define MAVLINK_MSG_ID_63_CRC 0
...
{ \
  ...
  { \
    ...
    { "pitch", NULL, MAVLINK_TYPE_INT16_T, 4, 2, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, pitch) }, \
    { "yaw", NULL, MAVLINK_TYPE_INT16_T, 4, 4, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, yaw) }, \
    { "thrust", NULL, MAVLINK_TYPE_UINT16_T, 4, 6, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, thrust) }, \
    { "group", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, group) }, \
    { "mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, mode) }, \
    { "led_red", NULL, MAVLINK_TYPE_UINT8_T, 4, 10, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, led_red) }, \
    { "led_blue", NULL, MAVLINK_TYPE_UINT8_T, 4, 11, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, led_blue) }, \
    { "led_green", NULL, MAVLINK_TYPE_UINT8_T, 4, 12, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, led_green) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_pack(
	 uint8_t system_id
	...
	)
{
	...
	_mav_put_int16_t_array(buf, 4, yaw, 4);
	_mav_put_uint16_t_array(buf, 6, thrust, 4);
	_mav_put_uint8_t_array(buf, 8, group, 0);
	_mav_put_uint8_t_array(buf, 9, mode, 0);
	_mav_put_uint8_t_array(buf, 10, led_red, 4);
	_mav_put_uint8_t_array(buf, 11, led_blue, 4);
	_mav_put_uint8_t_array(buf, 12, led_green, 4);
	...
	mav_array_memcpy(packet.group, group, sizeof(uint8_t)*0);
	mav_array_memcpy(packet.mode, mode, sizeof(uint8_t)*0);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t* set_quad_swarm_led_roll_pitch_yaw_thrust
	)
{
	return mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_pack(
	 system_id
	,component_id
	,msg
	,set_quad_swarm_led_roll_pitch_yaw_thrust->group
	,set_quad_swarm_led_roll_pitch_yaw_thrust->mode
	,set_quad_swarm_led_roll_pitch_yaw_thrust->led_red
	,set_quad_swarm_led_roll_pitch_yaw_thrust->led_blue
	,set_quad_swarm_led_roll_pitch_yaw_thrust->led_green
	,set_quad_swarm_led_roll_pitch_yaw_thrust->roll
	,set_quad_swarm_led_roll_pitch_yaw_thrust->pitch
	,set_quad_swarm_led_roll_pitch_yaw_thrust->yaw
	,set_quad_swarm_led_roll_pitch_yaw_thrust->thrust
	);
}
 ...
 * @param set_quad_swarm_led_roll_pitch_yaw_thrust C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
static inline void mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_send(
...
static inline void mavlink_msg_wID_set_quad_swarm_led_roll_pitch_yaw_thrust_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t group
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST, buf, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_LEN, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST, buf, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_LEN);
#endif
#else
	mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t packet;
	packet.group = group;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST, (const char*)&packet, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_LEN, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST, (const char*)&packet, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_LEN);
#endif
#endif
}
 ...
 */
static inline uint8_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_get_led_red(const mavlink_message_t* msg, uint8_t* led_red)
{
	return _MAV_RETURN_uint8_t_array(msg,led_red,4,2);
}
 ...
 */
static inline uint8_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_get_led_blue(const mavlink_message_t* msg, uint8_t* led_blue)
{
	return _MAV_RETURN_uint8_t_array(msg,led_blue,4,3);
}
 ...
 */
static inline uint8_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_get_led_green(const mavlink_message_t* msg, uint8_t* led_green)
{
	return _MAV_RETURN_uint8_t_array(msg,led_green,4,4);
}
 ...
 */
static inline int16_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_get_roll(const mavlink_message_t* msg, int16_t* roll)
{
	return _MAV_RETURN_int16_t_array(msg,roll,4,5);
}
 ...
 */
static inline int16_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_get_pitch(const mavlink_message_t* msg, int16_t* pitch)
{
	return _MAV_RETURN_int16_t_array(msg,pitch,4,7);
}
 ...
 */
static inline int16_t mavlink_msg_set_quad_swarm_led_roll_pitch_yaw_thrust_get_yaw(const mavlink_message_t* msg, int16_t* yaw)
{
	return _MAV_RETURN_int16_t_array(msg,yaw,4,9);
}
...
{
	return _MAV_RETURN_uint16_t_array(msg,thrust,4,11);
}
