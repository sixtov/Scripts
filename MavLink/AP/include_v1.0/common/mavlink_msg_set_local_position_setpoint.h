...
#define MAVLINK_MSG_ID_SET_LOCAL_POSITION_SETPOINT_CRC 0
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_set_local_position_setpoint_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_set_local_position_setpoint_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_set_local_position_setpoint_pack(
	 system_id
	,component_id
	,msg
	,set_local_position_setpoint->target_system
	,set_local_position_setpoint->target_component
	,set_local_position_setpoint->coordinate_frame
	,set_local_position_setpoint->x
	,set_local_position_setpoint->y
	,set_local_position_setpoint->z
	,set_local_position_setpoint->yaw
	);
}
 ...
 * @param set_local_position_setpoint C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_local_position_setpoint_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
static inline void mavlink_msg_set_local_position_setpoint_send(
...
static inline void mavlink_msg_wID_set_local_position_setpoint_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_LOCAL_POSITION_SETPOINT, buf, MAVLINK_MSG_ID_SET_LOCAL_POSITION_SETPOINT_LEN);
#endif
#else
	mavlink_set_local_position_setpoint_t packet;
	packet.target_system = target_system;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_LOCAL_POSITION_SETPOINT, (const char*)&packet, MAVLINK_MSG_ID_SET_LOCAL_POSITION_SETPOINT_LEN, MAVLINK_MSG_ID_SET_LOCAL_POSITION_SETPOINT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_LOCAL_POSITION_SETPOINT, (const char*)&packet, MAVLINK_MSG_ID_SET_LOCAL_POSITION_SETPOINT_LEN);
#endif
#endif
}
