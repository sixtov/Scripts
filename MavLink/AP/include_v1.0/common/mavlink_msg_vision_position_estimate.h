...
#define MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE_CRC 0
#define MAVLINK_MSG_ID_102_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_vision_position_estimate_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_vision_position_estimate_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_vision_position_estimate_pack(
	 system_id
	,component_id
	,msg
 ...
 * @param vision_position_estimate C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_vision_position_estimate_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_vision_position_estimate_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_vision_position_estimate_send(
...
static inline void mavlink_msg_wID_vision_position_estimate_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE, buf, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE_LEN, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE, buf, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE_LEN);
#endif
#else
	mavlink_vision_position_estimate_t packet;
	packet.usec = usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE, (const char*)&packet, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE_LEN, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE, (const char*)&packet, MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE_LEN);
#endif
#endif
}
