...
#define MAVLINK_MSG_ID_SIM_STATE_CRC 0
#define MAVLINK_MSG_ID_108_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_sim_state_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_sim_state_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_sim_state_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_sim_state_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_wID_sim_state_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,float q1
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SIM_STATE, buf, MAVLINK_MSG_ID_SIM_STATE_LEN, MAVLINK_MSG_ID_SIM_STATE_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SIM_STATE, buf, MAVLINK_MSG_ID_SIM_STATE_LEN);
#endif
#else
	mavlink_sim_state_t packet;
	packet.q1 = q1;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SIM_STATE, (const char*)&packet, MAVLINK_MSG_ID_SIM_STATE_LEN, MAVLINK_MSG_ID_SIM_STATE_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SIM_STATE, (const char*)&packet, MAVLINK_MSG_ID_SIM_STATE_LEN);
#endif
#endif
}
