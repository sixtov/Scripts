...
#define MAVLINK_MSG_ID_MEMORY_VECT_CRC 0
#define MAVLINK_MSG_ID_249_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_memory_vect_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_memory_vect_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_memory_vect_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param memory_vect C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_memory_vect_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_memory_vect_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_memory_vect_send(
...
static inline void mavlink_msg_wID_memory_vect_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint16_t address
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MEMORY_VECT, buf, MAVLINK_MSG_ID_MEMORY_VECT_LEN, MAVLINK_MSG_ID_MEMORY_VECT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MEMORY_VECT, buf, MAVLINK_MSG_ID_MEMORY_VECT_LEN);
#endif
#else
	mavlink_memory_vect_t packet;
	packet.address = address;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MEMORY_VECT, (const char*)&packet, MAVLINK_MSG_ID_MEMORY_VECT_LEN, MAVLINK_MSG_ID_MEMORY_VECT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MEMORY_VECT, (const char*)&packet, MAVLINK_MSG_ID_MEMORY_VECT_LEN);
#endif
#endif
}
 ...
 */
static inline int8_t mavlink_msg_memory_vect_get_value(const mavlink_message_t* msg, int8_t* value)
{
