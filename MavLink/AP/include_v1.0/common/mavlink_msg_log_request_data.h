...
#define MAVLINK_MSG_ID_LOG_REQUEST_DATA_CRC 0
#define MAVLINK_MSG_ID_119_CRC 0
...
{ \
  ...
  5, \
  { \
    { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_log_request_data_t, target_system) }, \
    { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_log_request_data_t, target_component) }, \
    { "id", NULL, MAVLINK_TYPE_UINT16_T, 0, 2, offsetof(mavlink_log_request_data_t, id) }, \
    { "ofs", NULL, MAVLINK_TYPE_UINT32_T, 0, 4, offsetof(mavlink_log_request_data_t, ofs) }, \
    { "count", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_log_request_data_t, count) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_log_request_data_pack(
	 uint8_t system_id
	...
	)
{
	...
	_mav_put_uint32_t(buf, 4, ofs);
	_mav_put_uint32_t(buf, 8, count);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_log_request_data_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
/**
 * @brief Encode a log_request_data struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_log_request_data_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param log_request_data C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_log_request_data_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_log_request_data_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_log_request_data_send(
...
static inline void mavlink_msg_wID_log_request_data_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_LOG_REQUEST_DATA, buf, MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN, MAVLINK_MSG_ID_LOG_REQUEST_DATA_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_LOG_REQUEST_DATA, buf, MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN);
#endif
#else
	mavlink_log_request_data_t packet;
	packet.target_system = target_system;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_LOG_REQUEST_DATA, (const char*)&packet, MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN, MAVLINK_MSG_ID_LOG_REQUEST_DATA_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_LOG_REQUEST_DATA, (const char*)&packet, MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN);
#endif
#endif
}
