...
#define MAVLINK_MSG_ID_ONBOARD_HEALTH_CRC 0
#define MAVLINK_MSG_ID_206_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_onboard_health_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_onboard_health_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
/**
 * @brief Encode a onboard_health struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_onboard_health_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_onboard_health_pack(
	 system_id
	,component_id
	,msg
	,onboard_health->uptime
	,onboard_health->cpu_freq
	,onboard_health->cpu_load
	,onboard_health->ram_usage
	,onboard_health->ram_total
	,onboard_health->swap_usage
	,onboard_health->swap_total
	,onboard_health->disk_health
	,onboard_health->disk_usage
	,onboard_health->disk_total
	,onboard_health->temp
	,onboard_health->voltage
	,onboard_health->network_load_in
 ...
 * @param onboard_health C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_onboard_health_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_onboard_health_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_onboard_health_send(
...
static inline void mavlink_msg_wID_onboard_health_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint32_t uptime
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ONBOARD_HEALTH, buf, MAVLINK_MSG_ID_ONBOARD_HEALTH_LEN, MAVLINK_MSG_ID_ONBOARD_HEALTH_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ONBOARD_HEALTH, buf, MAVLINK_MSG_ID_ONBOARD_HEALTH_LEN);
#endif
#else
	mavlink_onboard_health_t packet;
	packet.uptime = uptime;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ONBOARD_HEALTH, (const char*)&packet, MAVLINK_MSG_ID_ONBOARD_HEALTH_LEN, MAVLINK_MSG_ID_ONBOARD_HEALTH_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ONBOARD_HEALTH, (const char*)&packet, MAVLINK_MSG_ID_ONBOARD_HEALTH_LEN);
#endif
#endif
}
