...
#define MAVLINK_MSG_ID_STATUSTEXT_CRC 0
#define MAVLINK_MSG_ID_253_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_statustext_pack(
	 uint8_t system_id
 ...
 */
static inline uint16_t mavlink_msg_statustext_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param statustext C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_statustext_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_statustext_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_statustext_send(
...
static inline void mavlink_msg_wID_statustext_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t severity
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_STATUSTEXT, buf, MAVLINK_MSG_ID_STATUSTEXT_LEN, MAVLINK_MSG_ID_STATUSTEXT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_STATUSTEXT, buf, MAVLINK_MSG_ID_STATUSTEXT_LEN);
#endif
#else
	mavlink_statustext_t packet;
	packet.severity = severity;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_STATUSTEXT, (const char*)&packet, MAVLINK_MSG_ID_STATUSTEXT_LEN, MAVLINK_MSG_ID_STATUSTEXT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_STATUSTEXT, (const char*)&packet, MAVLINK_MSG_ID_STATUSTEXT_LEN);
#endif
#endif
}
 ...
 */
static inline char mavlink_msg_statustext_get_text(const mavlink_message_t* msg, char* text)
{
