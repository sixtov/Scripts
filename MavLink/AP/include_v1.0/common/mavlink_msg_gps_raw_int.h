...
#define MAVLINK_MSG_ID_GPS_RAW_INT_CRC 0
#define MAVLINK_MSG_ID_24_CRC 0
...
{ \
  ...
  { \
    ...
    { "eph", NULL, MAVLINK_TYPE_UINT16_T, 0, 21, offsetof(mavlink_gps_raw_int_t, eph) }, \
    { "epv", NULL, MAVLINK_TYPE_UINT16_T, 0, 23, offsetof(mavlink_gps_raw_int_t, epv) }, \
    { "vel", NULL, MAVLINK_TYPE_UINT16_T, 0, 25, offsetof(mavlink_gps_raw_int_t, vel) }, \
    { "cog", NULL, MAVLINK_TYPE_UINT16_T, 0, 27, offsetof(mavlink_gps_raw_int_t, cog) }, \
 ...
 * @param gps_raw_int C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_gps_raw_int_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_gps_raw_int_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_RAW_INT, buf, MAVLINK_MSG_ID_GPS_RAW_INT_LEN, MAVLINK_MSG_ID_GPS_RAW_INT_CRC);
#else
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_RAW_INT, (const char*)&packet, MAVLINK_MSG_ID_GPS_RAW_INT_LEN, MAVLINK_MSG_ID_GPS_RAW_INT_CRC);
#else
