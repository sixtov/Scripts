...
#define MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_CRC 0
#define MAVLINK_MSG_ID_55_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_safety_allowed_area_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_safety_allowed_area_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
	...
	)
{
	...
	,component_id
	,msg
	,safety_allowed_area->frame
	,safety_allowed_area->p1x
	,safety_allowed_area->p1y
	,safety_allowed_area->p1z
	,safety_allowed_area->p2x
	,safety_allowed_area->p2y
	,safety_allowed_area->p2z
	);
}
 ...
 * @param safety_allowed_area C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_safety_allowed_area_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
static inline void mavlink_msg_safety_allowed_area_send(
...
static inline void mavlink_msg_wID_safety_allowed_area_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t frame
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA, buf, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_LEN, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA, buf, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_LEN);
#endif
#else
	mavlink_safety_allowed_area_t packet;
	packet.frame = frame;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA, (const char*)&packet, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_LEN, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA, (const char*)&packet, MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_LEN);
#endif
#endif
}
