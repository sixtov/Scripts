...
#define MAVLINK_MSG_ID_HWSTATUS_CRC 0
#define MAVLINK_MSG_ID_165_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_hwstatus_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_hwstatus_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_hwstatus_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_hwstatus_pack(
	 system_id
	,component_id
	,msg
	,hwstatus->Vcc
 ...
 * @param hwstatus C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_hwstatus_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_hwstatus_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_hwstatus_send(
...
static inline void mavlink_msg_wID_hwstatus_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint16_t Vcc
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HWSTATUS, buf, MAVLINK_MSG_ID_HWSTATUS_LEN, MAVLINK_MSG_ID_HWSTATUS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HWSTATUS, buf, MAVLINK_MSG_ID_HWSTATUS_LEN);
#endif
#else
	mavlink_hwstatus_t packet;
	packet.Vcc = Vcc;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HWSTATUS, (const char*)&packet, MAVLINK_MSG_ID_HWSTATUS_LEN, MAVLINK_MSG_ID_HWSTATUS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HWSTATUS, (const char*)&packet, MAVLINK_MSG_ID_HWSTATUS_LEN);
#endif
#endif
}
