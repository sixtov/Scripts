...
#define MAVLINK_MSG_ID_HEARTBEAT_CRC 0
#define MAVLINK_MSG_ID_0_CRC 0
...
{
	return mavlink_msg_heartbeat_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HEARTBEAT, buf, MAVLINK_MSG_ID_HEARTBEAT_LEN, MAVLINK_MSG_ID_HEARTBEAT_CRC);
#else
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HEARTBEAT, (const char*)&packet, MAVLINK_MSG_ID_HEARTBEAT_LEN, MAVLINK_MSG_ID_HEARTBEAT_CRC);
#else
