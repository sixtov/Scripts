...
#define MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL_CRC 0
#define MAVLINK_MSG_ID_153_CRC 0
...
static inline uint16_t mavlink_msg_image_trigger_control_encode(
	...
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_image_trigger_control_t* image_trigger_control
	)
{
 ...
 * @param image_trigger_control C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_image_trigger_control_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_image_trigger_control_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_image_trigger_control_send(
...
static inline void mavlink_msg_wID_image_trigger_control_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t enable
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL, buf, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL, buf, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL_LEN);
#endif
#else
	mavlink_image_trigger_control_t packet;
	packet.enable = enable;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL, (const char*)&packet, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL, (const char*)&packet, MAVLINK_MSG_ID_IMAGE_TRIGGER_CONTROL_LEN);
#endif
#endif
}
