...
#define MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_CRC 0
...
{ \
  ...
  { \
    ...
    { "sensor_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_hil_optical_flow_t, sensor_id) }, \
    { "flow_x", NULL, MAVLINK_TYPE_INT16_T, 0, 9, offsetof(mavlink_hil_optical_flow_t, flow_x) }, \
    { "flow_y", NULL, MAVLINK_TYPE_INT16_T, 0, 11, offsetof(mavlink_hil_optical_flow_t, flow_y) }, \
    { "flow_comp_m_x", NULL, MAVLINK_TYPE_FLOAT, 0, 13, offsetof(mavlink_hil_optical_flow_t, flow_comp_m_x) }, \
    { "flow_comp_m_y", NULL, MAVLINK_TYPE_FLOAT, 0, 17, offsetof(mavlink_hil_optical_flow_t, flow_comp_m_y) }, \
    { "quality", NULL, MAVLINK_TYPE_UINT8_T, 0, 21, offsetof(mavlink_hil_optical_flow_t, quality) }, \
    { "ground_distance", NULL, MAVLINK_TYPE_FLOAT, 0, 22, offsetof(mavlink_hil_optical_flow_t, ground_distance) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_hil_optical_flow_pack(
	 uint8_t system_id
	...
	)
{
	...
	_mav_put_float(buf, 13, flow_comp_m_x);
	_mav_put_float(buf, 17, flow_comp_m_y);
	_mav_put_uint8_t(buf, 21, quality);
	_mav_put_float(buf, 22, ground_distance);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_hil_optical_flow_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_hil_optical_flow_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	...
	)
{
	...
	,hil_optical_flow->flow_x
	,hil_optical_flow->flow_y
	,hil_optical_flow->flow_comp_m_x
	,hil_optical_flow->flow_comp_m_y
	,hil_optical_flow->quality
	,hil_optical_flow->ground_distance
	);
}
 ...
 * @param hil_optical_flow C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_hil_optical_flow_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
static inline void mavlink_msg_hil_optical_flow_send(
...
static inline void mavlink_msg_wID_hil_optical_flow_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t time_usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW, buf, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_LEN, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW, buf, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_LEN);
#endif
#else
	mavlink_hil_optical_flow_t packet;
	packet.time_usec = time_usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW, (const char*)&packet, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_LEN, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW, (const char*)&packet, MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_LEN);
#endif
#endif
}
