...
#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC 0
#define MAVLINK_MSG_ID_115_CRC 0
...
{ \
  ...
  { \
    ...
    { "rollspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_hil_state_quaternion_t, rollspeed) }, \
    { "pitchspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_hil_state_quaternion_t, pitchspeed) }, \
    { "yawspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_hil_state_quaternion_t, yawspeed) }, \
    { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 24, offsetof(mavlink_hil_state_quaternion_t, lat) }, \
    { "lon", NULL, MAVLINK_TYPE_INT32_T, 0, 28, offsetof(mavlink_hil_state_quaternion_t, lon) }, \
    { "alt", NULL, MAVLINK_TYPE_INT32_T, 0, 32, offsetof(mavlink_hil_state_quaternion_t, alt) }, \
    { "vx", NULL, MAVLINK_TYPE_INT16_T, 0, 36, offsetof(mavlink_hil_state_quaternion_t, vx) }, \
    { "vy", NULL, MAVLINK_TYPE_INT16_T, 0, 38, offsetof(mavlink_hil_state_quaternion_t, vy) }, \
    { "vz", NULL, MAVLINK_TYPE_INT16_T, 0, 40, offsetof(mavlink_hil_state_quaternion_t, vz) }, \
    { "ind_airspeed", NULL, MAVLINK_TYPE_UINT16_T, 0, 42, offsetof(mavlink_hil_state_quaternion_t, ind_airspeed) }, \
    { "true_airspeed", NULL, MAVLINK_TYPE_UINT16_T, 0, 44, offsetof(mavlink_hil_state_quaternion_t, true_airspeed) }, \
    { "xacc", NULL, MAVLINK_TYPE_INT16_T, 0, 46, offsetof(mavlink_hil_state_quaternion_t, xacc) }, \
    { "yacc", NULL, MAVLINK_TYPE_INT16_T, 0, 48, offsetof(mavlink_hil_state_quaternion_t, yacc) }, \
    { "zacc", NULL, MAVLINK_TYPE_INT16_T, 0, 50, offsetof(mavlink_hil_state_quaternion_t, zacc) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_pack(
	 uint8_t system_id
	...
	)
{
	...
	_mav_put_uint16_t(buf, 42, ind_airspeed);
	_mav_put_uint16_t(buf, 44, true_airspeed);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_hil_state_quaternion_pack(
	 system_id
	,component_id
	,msg
 ...
 * @param hil_state_quaternion C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_hil_state_quaternion_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_wID_hil_state_quaternion_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t time_usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_STATE_QUATERNION, buf, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_STATE_QUATERNION, buf, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN);
#endif
#else
	mavlink_hil_state_quaternion_t packet;
	packet.time_usec = time_usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_STATE_QUATERNION, (const char*)&packet, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_STATE_QUATERNION, (const char*)&packet, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN);
#endif
#endif
}
