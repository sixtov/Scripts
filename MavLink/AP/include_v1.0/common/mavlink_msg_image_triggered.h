...
#define MAVLINK_MSG_ID_IMAGE_TRIGGERED_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_image_triggered_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_image_triggered_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_image_triggered_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_image_triggered_pack(
	 system_id
	,component_id
	,msg
	,image_triggered->timestamp
	,image_triggered->seq
	,image_triggered->roll
	,image_triggered->pitch
	,image_triggered->yaw
	,image_triggered->local_z
	,image_triggered->lat
	,image_triggered->lon
	,image_triggered->alt
	,image_triggered->ground_x
 ...
 * @param image_triggered C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_image_triggered_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_image_triggered_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_image_triggered_send(
...
static inline void mavlink_msg_wID_image_triggered_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t timestamp
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_IMAGE_TRIGGERED, buf, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_IMAGE_TRIGGERED, buf, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN);
#endif
#else
	mavlink_image_triggered_t packet;
	packet.timestamp = timestamp;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_IMAGE_TRIGGERED, (const char*)&packet, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN, MAVLINK_MSG_ID_IMAGE_TRIGGERED_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_IMAGE_TRIGGERED, (const char*)&packet, MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN);
#endif
#endif
}
