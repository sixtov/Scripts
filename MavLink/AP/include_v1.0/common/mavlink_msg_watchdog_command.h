...
#define MAVLINK_MSG_ID_WATCHDOG_COMMAND_CRC 0
#define MAVLINK_MSG_ID_183_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_watchdog_command_pack(
	 uint8_t system_id
...
static inline uint16_t mavlink_msg_watchdog_command_encode(
	...
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_watchdog_command_t* watchdog_command
	)
{
	return mavlink_msg_watchdog_command_pack(
	 system_id
	,component_id
	,msg
	,watchdog_command->target_system_id
	,watchdog_command->watchdog_id
	,watchdog_command->process_id
 ...
 * @param watchdog_command C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_watchdog_command_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_watchdog_command_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_watchdog_command_send(
...
static inline void mavlink_msg_wID_watchdog_command_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system_id
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_WATCHDOG_COMMAND, buf, MAVLINK_MSG_ID_WATCHDOG_COMMAND_LEN, MAVLINK_MSG_ID_WATCHDOG_COMMAND_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_WATCHDOG_COMMAND, buf, MAVLINK_MSG_ID_WATCHDOG_COMMAND_LEN);
#endif
#else
	mavlink_watchdog_command_t packet;
	packet.target_system_id = target_system_id;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_WATCHDOG_COMMAND, (const char*)&packet, MAVLINK_MSG_ID_WATCHDOG_COMMAND_LEN, MAVLINK_MSG_ID_WATCHDOG_COMMAND_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_WATCHDOG_COMMAND, (const char*)&packet, MAVLINK_MSG_ID_WATCHDOG_COMMAND_LEN);
#endif
#endif
}
