...
#define MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_CRC 0
#define MAVLINK_MSG_ID_170_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_position_control_setpoint_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_position_control_setpoint_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_position_control_setpoint_pack(
	 system_id
	,component_id
	,msg
	,position_control_setpoint->id
	,position_control_setpoint->x
	,position_control_setpoint->y
	,position_control_setpoint->z
	,position_control_setpoint->yaw
	);
}
 ...
 * @param position_control_setpoint C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_position_control_setpoint_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_position_control_setpoint_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_position_control_setpoint_send(
...
static inline void mavlink_msg_wID_position_control_setpoint_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint16_t id
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT, buf, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT, buf, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN);
#endif
#else
	mavlink_position_control_setpoint_t packet;
	packet.id = id;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT, (const char*)&packet, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT, (const char*)&packet, MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN);
#endif
#endif
}
