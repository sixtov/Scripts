...
#define MAVLINK_MSG_ID_VFR_HUD_CRC 0
#define MAVLINK_MSG_ID_74_CRC 0
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_vfr_hud_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_vfr_hud_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param vfr_hud C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_vfr_hud_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_vfr_hud_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_vfr_hud_send(
...
static inline void mavlink_msg_wID_vfr_hud_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,float airspeed
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VFR_HUD, buf, MAVLINK_MSG_ID_VFR_HUD_LEN);
#endif
#else
	mavlink_vfr_hud_t packet;
	packet.airspeed = airspeed;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VFR_HUD, (const char*)&packet, MAVLINK_MSG_ID_VFR_HUD_LEN, MAVLINK_MSG_ID_VFR_HUD_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VFR_HUD, (const char*)&packet, MAVLINK_MSG_ID_VFR_HUD_LEN);
#endif
#endif
}
