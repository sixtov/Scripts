...
#define MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST_CRC 0
#define MAVLINK_MSG_ID_56_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_set_roll_pitch_yaw_thrust_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_set_roll_pitch_yaw_thrust_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_set_roll_pitch_yaw_thrust_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_set_roll_pitch_yaw_thrust_pack(
	 system_id
	,component_id
	,msg
	,set_roll_pitch_yaw_thrust->target_system
	,set_roll_pitch_yaw_thrust->target_component
	,set_roll_pitch_yaw_thrust->roll
	,set_roll_pitch_yaw_thrust->pitch
	,set_roll_pitch_yaw_thrust->yaw
	,set_roll_pitch_yaw_thrust->thrust
	);
}
 ...
 * @param set_roll_pitch_yaw_thrust C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_roll_pitch_yaw_thrust_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_set_roll_pitch_yaw_thrust_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_set_roll_pitch_yaw_thrust_send(
...
static inline void mavlink_msg_wID_set_roll_pitch_yaw_thrust_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST, buf, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST_LEN, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST, buf, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST_LEN);
#endif
#else
	mavlink_set_roll_pitch_yaw_thrust_t packet;
	packet.target_system = target_system;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST, (const char*)&packet, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST_LEN, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST, (const char*)&packet, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST_LEN);
#endif
#endif
}
