...
{ 
  ...
  uint8_t group_mlx[0];  ///< Actuator group. The "_mlx" indicates this is a multi-instance message and a MAVLink parser should use this field to difference between instances.
} mavlink_actuator_control_target_t;

#define MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN 41
#define MAVLINK_MSG_ID_140_LEN 41

#define MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_CRC 0
#define MAVLINK_MSG_ID_140_CRC 0
...
{ \
  ...
  { \
    ...
    { "group_mlx", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_actuator_control_target_t, group_mlx) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_actuator_control_target_pack(
	 uint8_t system_id
	...
	)
{
	...
	_mav_put_uint8_t_array(buf, 12, group_mlx, 0);
	...
	mav_array_memcpy(packet.group_mlx, group_mlx, sizeof(uint8_t)*0);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_actuator_control_target_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
/**
 * @brief Encode a actuator_control_target struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_actuator_control_target_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_actuator_control_target_pack(
	 system_id
	,component_id
	,msg
 ...
 * @param actuator_control_target C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_actuator_control_target_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_actuator_control_target_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_actuator_control_target_send(
...
static inline void mavlink_msg_wID_actuator_control_target_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t time_usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET, buf, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET, buf, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN);
#endif
#else
	mavlink_actuator_control_target_t packet;
	packet.time_usec = time_usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET, (const char*)&packet, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET, (const char*)&packet, MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN);
#endif
#endif
}
 ...
 */
static inline float mavlink_msg_actuator_control_target_get_controls(const mavlink_message_t* msg, float* controls)
{
	return _MAV_RETURN_float_array(msg,controls,8,9);
}
