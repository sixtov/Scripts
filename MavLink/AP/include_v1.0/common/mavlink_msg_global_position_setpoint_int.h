...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT_CRC 0
#define MAVLINK_MSG_ID_52_CRC 0
...
{ \
  ...
  5, \
  { \
    { "coordinate_frame", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_global_position_setpoint_int_t, coordinate_frame) }, \
    { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 1, offsetof(mavlink_global_position_setpoint_int_t, latitude) }, \
    { "longitude", NULL, MAVLINK_TYPE_INT32_T, 0, 5, offsetof(mavlink_global_position_setpoint_int_t, longitude) }, \
    { "altitude", NULL, MAVLINK_TYPE_INT32_T, 0, 9, offsetof(mavlink_global_position_setpoint_int_t, altitude) }, \
    { "yaw", NULL, MAVLINK_TYPE_INT16_T, 0, 13, offsetof(mavlink_global_position_setpoint_int_t, yaw) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_global_position_setpoint_int_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_global_position_setpoint_int_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_global_position_setpoint_int_pack(
	 system_id
	,component_id
	,msg
	,global_position_setpoint_int->coordinate_frame
	,global_position_setpoint_int->latitude
	,global_position_setpoint_int->longitude
	,global_position_setpoint_int->altitude
	,global_position_setpoint_int->yaw
	);
}
 ...
 * @param global_position_setpoint_int C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_global_position_setpoint_int_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_global_position_setpoint_int_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_global_position_setpoint_int_send(
...
static inline void mavlink_msg_wID_global_position_setpoint_int_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t coordinate_frame
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT, buf, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT_LEN, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT, buf, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT_LEN);
#endif
#else
	mavlink_global_position_setpoint_int_t packet;
	packet.coordinate_frame = coordinate_frame;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT, (const char*)&packet, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT_LEN, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT, (const char*)&packet, MAVLINK_MSG_ID_GLOBAL_POSITION_SETPOINT_INT_LEN);
#endif
#endif
}
