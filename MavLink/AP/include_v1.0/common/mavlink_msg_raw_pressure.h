...
#define MAVLINK_MSG_ID_RAW_PRESSURE_CRC 0
#define MAVLINK_MSG_ID_28_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_raw_pressure_pack(
	 uint8_t system_id
 ...
 * @param raw_pressure C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_raw_pressure_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_raw_pressure_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_raw_pressure_send(
...
static inline void mavlink_msg_wID_raw_pressure_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t time_usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_RAW_PRESSURE, buf, MAVLINK_MSG_ID_RAW_PRESSURE_LEN, MAVLINK_MSG_ID_RAW_PRESSURE_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_RAW_PRESSURE, buf, MAVLINK_MSG_ID_RAW_PRESSURE_LEN);
#endif
#else
	mavlink_raw_pressure_t packet;
	packet.time_usec = time_usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_RAW_PRESSURE, (const char*)&packet, MAVLINK_MSG_ID_RAW_PRESSURE_LEN, MAVLINK_MSG_ID_RAW_PRESSURE_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_RAW_PRESSURE, (const char*)&packet, MAVLINK_MSG_ID_RAW_PRESSURE_LEN);
#endif
#endif
}
