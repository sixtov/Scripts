...
#define MAVLINK_MSG_ID_SET_CAM_SHUTTER_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_set_cam_shutter_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_set_cam_shutter_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_set_cam_shutter_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_set_cam_shutter_t* set_cam_shutter
	)
{
	...
	,component_id
	,msg
	,set_cam_shutter->cam_no
	,set_cam_shutter->cam_mode
	,set_cam_shutter->trigger_pin
	,set_cam_shutter->interval
	,set_cam_shutter->exposure
	,set_cam_shutter->gain
	);
}
 ...
 * @param set_cam_shutter C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_cam_shutter_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_set_cam_shutter_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_set_cam_shutter_send(
...
static inline void mavlink_msg_wID_set_cam_shutter_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t cam_no
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_CAM_SHUTTER, buf, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_CAM_SHUTTER, buf, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN);
#endif
#else
	mavlink_set_cam_shutter_t packet;
	packet.cam_no = cam_no;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_CAM_SHUTTER, (const char*)&packet, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN, MAVLINK_MSG_ID_SET_CAM_SHUTTER_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_CAM_SHUTTER, (const char*)&packet, MAVLINK_MSG_ID_SET_CAM_SHUTTER_LEN);
#endif
#endif
}
