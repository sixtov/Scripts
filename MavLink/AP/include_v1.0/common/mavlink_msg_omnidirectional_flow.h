...
#define MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW_CRC 0
#define MAVLINK_MSG_ID_106_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_omnidirectional_flow_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_omnidirectional_flow_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_omnidirectional_flow_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_omnidirectional_flow_pack(
	 system_id
	,component_id
	,msg
	,omnidirectional_flow->time_usec
	,omnidirectional_flow->sensor_id
	,omnidirectional_flow->left
	,omnidirectional_flow->right
	,omnidirectional_flow->quality
	,omnidirectional_flow->front_distance_m
	);
}
 ...
 * @param omnidirectional_flow C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_omnidirectional_flow_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_omnidirectional_flow_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_omnidirectional_flow_send(
...
static inline void mavlink_msg_wID_omnidirectional_flow_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t time_usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW, buf, MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW_LEN);
#endif
#else
	mavlink_omnidirectional_flow_t packet;
	packet.time_usec = time_usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW, (const char*)&packet, MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW_LEN, MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW, (const char*)&packet, MAVLINK_MSG_ID_OMNIDIRECTIONAL_FLOW_LEN);
#endif
#endif
}
 ...
 */
static inline int16_t mavlink_msg_omnidirectional_flow_get_left(const mavlink_message_t* msg, int16_t* left)
{
	return _MAV_RETURN_int16_t_array(msg,left,10,9);
}
 ...
 */
static inline int16_t mavlink_msg_omnidirectional_flow_get_right(const mavlink_message_t* msg, int16_t* right)
{
	return _MAV_RETURN_int16_t_array(msg,right,10,11);
}
