...
#define MAVLINK_MSG_ID_MISSION_REQUEST_LIST_CRC 0
#define MAVLINK_MSG_ID_43_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_mission_request_list_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_mission_request_list_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_mission_request_list_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
	,const mavlink_mission_request_list_t* mission_request_list
	)
{
	return mavlink_msg_mission_request_list_pack(
	 system_id
	,component_id
	,msg
 ...
 * @param mission_request_list C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_mission_request_list_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_mission_request_list_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_mission_request_list_send(
...
static inline void mavlink_msg_wID_mission_request_list_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MISSION_REQUEST_LIST, buf, MAVLINK_MSG_ID_MISSION_REQUEST_LIST_LEN, MAVLINK_MSG_ID_MISSION_REQUEST_LIST_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MISSION_REQUEST_LIST, buf, MAVLINK_MSG_ID_MISSION_REQUEST_LIST_LEN);
#endif
#else
	mavlink_mission_request_list_t packet;
	packet.target_system = target_system;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MISSION_REQUEST_LIST, (const char*)&packet, MAVLINK_MSG_ID_MISSION_REQUEST_LIST_LEN, MAVLINK_MSG_ID_MISSION_REQUEST_LIST_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_MISSION_REQUEST_LIST, (const char*)&packet, MAVLINK_MSG_ID_MISSION_REQUEST_LIST_LEN);
#endif
#endif
}
