...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_CRC 0
...
{ \
  ...
  { \
    ...
    { "estimator_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 44, offsetof(mavlink_global_position_int_cov_t, estimator_type) }, \
  } \
}
 ...
 */
static inline uint16_t mavlink_msg_global_position_int_cov_pack(
	 uint8_t system_id
	...
	)
{
	...
	_mav_put_float(buf, 40, covariance);
	_mav_put_uint8_t_array(buf, 44, estimator_type, 0);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_global_position_int_cov_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
/**
 * @brief Encode a global_position_int_cov struct into a message
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 ...
 */
static inline uint16_t mavlink_msg_global_position_int_cov_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param global_position_int_cov C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_global_position_int_cov_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
static inline void mavlink_msg_global_position_int_cov_send(
...
static inline void mavlink_msg_wID_global_position_int_cov_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint32_t time_boot_ms
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV, buf, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV, buf, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN);
#endif
#else
	mavlink_global_position_int_cov_t packet;
	packet.time_boot_ms = time_boot_ms;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV, (const char*)&packet, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV, (const char*)&packet, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN);
#endif
#endif
}
...
{
	return _MAV_RETURN_int32_t(msg,21);
}
...
{
	return _MAV_RETURN_int32_t(msg,25);
}
 ...
 */
static inline float mavlink_msg_global_position_int_cov_get_covariance(const mavlink_message_t* msg, float* covariance)
{
	return _MAV_RETURN_float_array(msg,covariance,36,41);
}
