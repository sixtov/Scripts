...
#define MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_CRC 0
#define MAVLINK_MSG_ID_160_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_set_position_control_offset_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_set_position_control_offset_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_set_position_control_offset_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_set_position_control_offset_pack(
	 system_id
	,component_id
	,msg
	,set_position_control_offset->target_system
	,set_position_control_offset->target_component
	,set_position_control_offset->x
	,set_position_control_offset->y
	,set_position_control_offset->z
	,set_position_control_offset->yaw
	);
}
 ...
 * @param set_position_control_offset C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_set_position_control_offset_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_set_position_control_offset_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_set_position_control_offset_send(
...
static inline void mavlink_msg_wID_set_position_control_offset_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t target_system
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET, buf, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET, buf, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN);
#endif
#else
	mavlink_set_position_control_offset_t packet;
	packet.target_system = target_system;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET, (const char*)&packet, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET, (const char*)&packet, MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN);
#endif
#endif
}
