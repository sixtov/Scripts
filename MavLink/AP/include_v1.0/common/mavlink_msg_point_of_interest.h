...
#define MAVLINK_MSG_ID_POINT_OF_INTEREST_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_point_of_interest_pack(
	 uint8_t system_id
...
{
	return mavlink_msg_point_of_interest_pack(
	 system_id
	,component_id
	,msg
	,point_of_interest->type
	,point_of_interest->color
	,point_of_interest->coordinate_system
	,point_of_interest->timeout
	,point_of_interest->x
	,point_of_interest->y
	,point_of_interest->z
 ...
 * @param point_of_interest C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_point_of_interest_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_point_of_interest_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_wID_point_of_interest_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint8_t type
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POINT_OF_INTEREST, buf, MAVLINK_MSG_ID_POINT_OF_INTEREST_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POINT_OF_INTEREST, buf, MAVLINK_MSG_ID_POINT_OF_INTEREST_LEN);
#endif
#else
	mavlink_point_of_interest_t packet;
	packet.type = type;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POINT_OF_INTEREST, (const char*)&packet, MAVLINK_MSG_ID_POINT_OF_INTEREST_LEN, MAVLINK_MSG_ID_POINT_OF_INTEREST_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_POINT_OF_INTEREST, (const char*)&packet, MAVLINK_MSG_ID_POINT_OF_INTEREST_LEN);
#endif
#endif
}
 ...
 * @return POI name
 */
static inline char mavlink_msg_point_of_interest_get_name(const mavlink_message_t* msg, char* name)
{
