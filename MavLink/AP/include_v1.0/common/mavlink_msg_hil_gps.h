...
#define MAVLINK_MSG_ID_HIL_GPS_CRC 0
#define MAVLINK_MSG_ID_113_CRC 0
...
{ \
  ...
  { \
    ...
    { "fix_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_hil_gps_t, fix_type) }, \
    { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 9, offsetof(mavlink_hil_gps_t, lat) }, \
    { "lon", NULL, MAVLINK_TYPE_INT32_T, 0, 13, offsetof(mavlink_hil_gps_t, lon) }, \
    { "alt", NULL, MAVLINK_TYPE_INT32_T, 0, 17, offsetof(mavlink_hil_gps_t, alt) }, \
    { "eph", NULL, MAVLINK_TYPE_UINT16_T, 0, 21, offsetof(mavlink_hil_gps_t, eph) }, \
    { "epv", NULL, MAVLINK_TYPE_UINT16_T, 0, 23, offsetof(mavlink_hil_gps_t, epv) }, \
    { "vel", NULL, MAVLINK_TYPE_UINT16_T, 0, 25, offsetof(mavlink_hil_gps_t, vel) }, \
    { "vn", NULL, MAVLINK_TYPE_INT16_T, 0, 27, offsetof(mavlink_hil_gps_t, vn) }, \
    { "ve", NULL, MAVLINK_TYPE_INT16_T, 0, 29, offsetof(mavlink_hil_gps_t, ve) }, \
    { "vd", NULL, MAVLINK_TYPE_INT16_T, 0, 31, offsetof(mavlink_hil_gps_t, vd) }, \
    { "cog", NULL, MAVLINK_TYPE_UINT16_T, 0, 33, offsetof(mavlink_hil_gps_t, cog) }, \
 ...
 */
static inline uint16_t mavlink_msg_hil_gps_pack(
	 uint8_t system_id
	...
	)
{
	...
	_mav_put_uint16_t(buf, 21, eph);
	_mav_put_uint16_t(buf, 23, epv);
	_mav_put_uint16_t(buf, 25, vel);
	_mav_put_int16_t(buf, 27, vn);
	_mav_put_int16_t(buf, 29, ve);
	_mav_put_int16_t(buf, 31, vd);
	_mav_put_uint16_t(buf, 33, cog);
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_hil_gps_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_hil_gps_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
 ...
 * @param hil_gps C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_hil_gps_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_hil_gps_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_hil_gps_send(
...
static inline void mavlink_msg_wID_hil_gps_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t time_usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_GPS, buf, MAVLINK_MSG_ID_HIL_GPS_LEN, MAVLINK_MSG_ID_HIL_GPS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_GPS, buf, MAVLINK_MSG_ID_HIL_GPS_LEN);
#endif
#else
	mavlink_hil_gps_t packet;
	packet.time_usec = time_usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_GPS, (const char*)&packet, MAVLINK_MSG_ID_HIL_GPS_LEN, MAVLINK_MSG_ID_HIL_GPS_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_HIL_GPS, (const char*)&packet, MAVLINK_MSG_ID_HIL_GPS_LEN);
#endif
#endif
}
...
{
	return _MAV_RETURN_int16_t(msg,29);
}
...
{
	return _MAV_RETURN_int16_t(msg,31);
}
