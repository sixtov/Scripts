...
#define MAVLINK_MSG_ID_GPS_STATUS_CRC 0
#define MAVLINK_MSG_ID_25_CRC 0
...
{ \
  ...
  { \
    ...
    { "satellite_used", NULL, MAVLINK_TYPE_UINT8_T, 20, 2, offsetof(mavlink_gps_status_t, satellite_used) }, \
    { "satellite_elevation", NULL, MAVLINK_TYPE_UINT8_T, 20, 3, offsetof(mavlink_gps_status_t, satellite_elevation) }, \
    { "satellite_azimuth", NULL, MAVLINK_TYPE_UINT8_T, 20, 4, offsetof(mavlink_gps_status_t, satellite_azimuth) }, \
    { "satellite_snr", NULL, MAVLINK_TYPE_UINT8_T, 20, 5, offsetof(mavlink_gps_status_t, satellite_snr) }, \
  } \
}
	...
	)
{
	...
	_mav_put_uint8_t_array(buf, 2, satellite_used, 20);
	_mav_put_uint8_t_array(buf, 3, satellite_elevation, 20);
	_mav_put_uint8_t_array(buf, 4, satellite_azimuth, 20);
	_mav_put_uint8_t_array(buf, 5, satellite_snr, 20);
 ...
 * @param gps_status C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_gps_status_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_STATUS, buf, MAVLINK_MSG_ID_GPS_STATUS_LEN, MAVLINK_MSG_ID_GPS_STATUS_CRC);
#else
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_GPS_STATUS, (const char*)&packet, MAVLINK_MSG_ID_GPS_STATUS_LEN, MAVLINK_MSG_ID_GPS_STATUS_CRC);
#else
...
{
	return _MAV_RETURN_uint8_t_array(msg,satellite_used,20,2);
}
...
{
	return _MAV_RETURN_uint8_t_array(msg,satellite_elevation,20,3);
}
...
{
	return _MAV_RETURN_uint8_t_array(msg,satellite_azimuth,20,4);
}
...
{
	return _MAV_RETURN_uint8_t_array(msg,satellite_snr,20,5);
}
