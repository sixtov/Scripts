...
#define MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_CRC 0
#define MAVLINK_MSG_ID_103_CRC 0
 ...
 */
static inline uint16_t mavlink_msg_vision_speed_estimate_pack(
	 uint8_t system_id
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_vision_speed_estimate_pack_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
 ...
 */
static inline uint16_t mavlink_msg_vision_speed_estimate_encode(
	 uint8_t system_id
	,uint8_t component_id
	,mavlink_message_t* msg
...
{
	return mavlink_msg_vision_speed_estimate_pack(
	 system_id
	,component_id
	,msg
 ...
 * @param vision_speed_estimate C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_vision_speed_estimate_encode_chan(
	 uint8_t system_id
	,uint8_t component_id
	,uint8_t chan
	,mavlink_message_t* msg
...
{
	return mavlink_msg_vision_speed_estimate_pack_chan(
	 system_id
	,component_id
	,chan
	,msg
...
static inline void mavlink_msg_vision_speed_estimate_send(
...
static inline void mavlink_msg_wID_vision_speed_estimate_send(
	 mavlink_channel_t chan
	,uint8_t sID
	,uint8_t cID
	,uint64_t usec
	...
	)
{
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE, buf, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_LEN, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE, buf, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_LEN);
#endif
#else
	mavlink_vision_speed_estimate_t packet;
	packet.usec = usec;
	...
	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE, (const char*)&packet, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_LEN, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_CRC);
#else

	_mav_wID_finalize_message_chan_send(chan, sID, cID, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE, (const char*)&packet, MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_LEN);
#endif
#endif
}
